...
if ( !function_exists( 'waa_get_prop' ) ) {
    /**
     *
     */
    function waa_get_prop( $object, $key, $single = true, $context = 'view' ) {

        $prop_map   = waa_return_new_attribute_map();
        ...
        if ( $is_wc_data ) {
            ...
            if ( isset( $object->$key ) ) {
                return $object->$key;
            } elseif ( waa_wc_check_post_columns( $key ) ) {
...
if ( !function_exists( 'waa_set_prop' ) ) {
    /**
     *
     */
    function waa_set_prop( $object, $arg1, $arg2 = false ) {
        ...
        foreach ( $arg1 as $key => $value ) {
            if ( $is_wc_data ) {
                ...
                if ( waa_wc_check_post_columns( $key ) ) {
...
if ( !function_exists( 'waa_save_prop' ) ) {
    /**
     *
     */
    function waa_save_prop( $object, $arg1, $arg2 = false, $force_update = false ) {
        if ( !is_array( $arg1 ) ) {
            $arg1 = array(
                $arg1 => $arg2
            );
        ...
        foreach ( $arg1 as $key => $value ) {
            waa_set_prop( $object, $key, $value );

            if ( !$is_wc_data ) {

                if ( waa_wc_check_post_columns( $key ) ) {
                    waa_store_changes( $object->post, $key, $value );
                } else {
                    $object_id = is_callable( array( $object, 'get_id' ) ) ? $object->get_id() : $object->id;
...
if ( !function_exists( 'waa_delete_prop' ) ) {
    /**
     *
     */
    function waa_delete_prop( $object, $key, $value = '' ) {
        $prop_map   = waa_return_new_attribute_map();
        $is_wc_data = $object instanceof WC_Data;
        ...
        if ( $is_wc_data ) {
            ...
            if ( waa_wc_check_post_columns( $key ) && ( !$value || $object->post->$key == $value ) ) {
                waa_store_changes( $object->post, $key, '' );
            } else {
                $object_id = is_callable( array( $object, 'get_id' ) ) ? $object->get_id() : $object->id;
...
if ( !function_exists( 'waa_return_new_attribute_map' ) ) {
    function waa_return_new_attribute_map() {
        return array(
...
if ( !function_exists( 'waa_store_changes' ) ) {
    function waa_store_changes( $object, $key, $value = false ) {
...
if ( !function_exists( 'waa_send_changes_to_db' ) ) {
    function waa_send_changes_to_db() {
        global $changed_objects;
        ...
        if ( !empty( $changed_objects ) ) {
            foreach ( $changed_objects as $id => $data ) {
                if ( version_compare( WC()->version, '2.7.0', '>=' ) ) {
                    ...
                    waa_set_prop( $object, $data[ 'changes' ] );
                    $object->save();
                } else {
                    $data[ 'ID' ] = $id;
                    wp_update_post( $data );
...
if ( !function_exists( 'waa_get_orders' ) ) {
    /**
     *
     */
    function waa_get_orders( $args ) {
...
if ( !function_exists( 'waa_get_products' ) ) {
    /**
     *
     */
    function waa_get_products( $args ) {
        if ( version_compare( WC()->version, '2.7', '<' ) ) {
            $args[ 'fields' ] = 'objects';
            $posts            = get_posts( $args );
...
if ( !function_exists( 'waa_update_product_stock' ) ) {
    /**
     *
     */
    function waa_update_product_stock( $product, $stock_quantity = 1, $operation = 'set' ) {
...
if ( !function_exists( 'waa_wc_deprecated_filters' ) ) {
    /**
     *
     */
    function waa_wc_deprecated_filters() {
        return apply_filters( 'waa_wc_deprecated_filters', array(
            ...
            'woocommerce_get_variation_price'            =>     'woocommerce_product_variation_get_price',
...
if ( !function_exists( 'waa_fix_wc_deprecated_filters' ) ) {
    /**
     *
     */
    function waa_fix_wc_deprecated_filters() {

        if ( !version_compare( WC()->version, '2.7.0', '<' ) ) {
            return;
        }

        $deprecated_filters = waa_wc_deprecated_filters();
        foreach ( $deprecated_filters as $old => $new ) {
            add_filter( $old, 'waa_wc_deprecated_filter_mapping', 10, 100 );
        }
    }
}

if ( !function_exists( 'waa_wc_deprecated_filter_mapping' ) ) {
    /**
     *
     */
    function waa_wc_deprecated_filter_mapping() {
        $deprecated_filters = waa_wc_deprecated_filters();
...
if ( !function_exists( 'waa_wc_check_post_columns' ) ) {
    /**
     *
     */
    function waa_wc_check_post_columns( $key ) {
        $columns = array(
            'post_author',
            'post_date',
            'post_date_gmt',
...
if ( !function_exists( 'waa_get_order_id' ) ) {
    /**
     ...
     * @return mixed
     */
    function waa_get_order_id( $order ) {
        return waa_get_prop( $order, 'id' );
    }
}

if ( !function_exists( 'waa_get_product_id' ) ) {
    /**
     ...
     * @return mixed
     */
    function waa_get_product_id( $product ) {
        return waa_get_prop( $product, 'id' );
    }
}

if ( !function_exists( 'waa_get_base_product_id' ) ) {
    /**
     ...
     * @return mixed
     */
    function waa_get_base_product_id( $product ) {

        return $product instanceof WC_Data && $product->is_type( 'variation' ) ?
            waa_get_prop( $product, 'parent_id' ) :
            waa_get_prop( $product, 'id' );
    }
}

if ( !function_exists( 'waa_get_display_price' ) ) {
    /**
     * @param WC_Product $product
     * @param string     $price
     * @param int        $qty
     */
    function waa_get_display_price( $product, $price = '', $qty = 1 ) {
...
if ( !function_exists( 'waa_get_price_excluding_tax' ) ) {
    /**
     * @param WC_Product $product
     * @param int        $qty
     * @param string     $price
     ...
     * @return float|string
     */
    function waa_get_price_excluding_tax( $product, $qty = 1, $price = '' ) {
...
if ( !function_exists( 'waa_get_price_including_tax' ) ) {
    /**
     * @param WC_Product $product
     * @param int        $qty
     * @param string     $price
     ...
     * @return float|string
     */
    function waa_get_price_including_tax( $product, $qty = 1, $price = '' ) {
...
if ( !function_exists( 'waa_get_product_image_id' ) ) {
    /**
     ...
     */
    function waa_get_product_image_id( $product, $context = 'view' ) {
...
if ( !function_exists( 'waa_get_refund_amount' ) ) {
    /**
     ...
     * @return float
     */
    function waa_get_refund_amount( $refund, $context = 'view' ) {
...
if ( !function_exists( 'waa_set_refund_amount' ) ){
    /**
     * @param $refund \WC_Order_Refund
     * @param $amount float
     *
     * @return float
     */
    function waa_set_refund_amount( $refund, $amount ){
        $is_wc_data = $refund instanceof WC_Data;
...
if ( !function_exists( 'waa_get_refund_reason' ) ){
    /**
     * @param $refund \WC_Order_Refund
     * @param $amount float
     *
     * @return float
     */
    function waa_get_refund_reason( $refund ){
        $is_wc_data = $refund instanceof WC_Data;
...
if ( !function_exists( 'waa_add_select2_fields' ) ) {
    /**
     * Add select 2
     *
     * @param array $args
     */
    function waa_add_select2_fields( $args = array() ) {
        $default = array(
            'type'              => 'hidden',
            'class'             => '',
            'id'                => '',
...
if ( !function_exists( 'waa_product_visibility_meta' ) ) {
    function waa_product_visibility_meta( $args ) {
        if ( version_compare( WC()->version, '2.7.0', '<' ) ) {
...
if ( !function_exists( 'waa_datetime_to_timestamp' ) ) {

    /**
     *
     */
    function waa_datetime_to_timestamp( $date ) {
...
waa_fix_wc_deprecated_filters();
add_action( 'shutdown', 'waa_send_changes_to_db' );